...
UniValue masternode(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "outputs") {
        ...
        pwalletMain->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_888);
...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print PlayerVsPlayerCoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "playervsplayercoin",               "masternode",             &masternode,             true,  {} },
    { "playervsplayercoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "playervsplayercoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "playervsplayercoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "playervsplayercoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "playervsplayercoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};

...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in playervsplayercoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("playervsplayercoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "playervsplayercoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "playervsplayercoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "playervsplayercoin",               "gobject",                &gobject,                true,  {} },
    { "playervsplayercoin",               "voteraw",                &voteraw,                true,  {} },

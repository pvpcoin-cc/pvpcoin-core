    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PVP-light"), QVariant("light"));
    ui->theme->addItem(QString("PVP-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("PVP-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("PVP-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("PVP-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("PVP-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PVP-traditional"), QVariant("trad"));

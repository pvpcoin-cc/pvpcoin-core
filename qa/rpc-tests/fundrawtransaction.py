...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid playervsplayercoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid playervsplayercoin address" in e.error['message'])

...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all PlayerVsPlayerCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat PlayerVsPlayerCoin and make it unusable. To
...
void ThreadCheckPrivateSendServer(CConnman& connman)
{
    ...
    RenameThread("playervsplayercoin-ps-server");

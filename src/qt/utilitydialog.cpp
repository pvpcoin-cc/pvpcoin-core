    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  playervsplayercoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the PlayerVsPlayerCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PVP, 0.1 PVP, 1 PVP and 10 PVP -- sort of like the paper money you use every day.</li> \

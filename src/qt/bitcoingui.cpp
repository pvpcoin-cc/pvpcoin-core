...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PlayerVsPlayerCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and playervsplayercoin: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about PlayerVsPlayerCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PlayerVsPlayerCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PlayerVsPlayerCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a playervsplayercoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible PlayerVsPlayerCoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PlayerVsPlayerCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("PlayerVsPlayerCoin Core"); // default title
    ...
    // Append title to "PlayerVsPlayerCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;

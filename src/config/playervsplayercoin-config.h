/* src/config/playervsplayercoin-config.h.  Generated from playervsplayercoin-config.h.in by configure.  */
/* src/config/playervsplayercoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The PlayerVsPlayerCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "PlayerVsPlayerCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/playervsplayercoinpay/playervsplayercoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "PlayerVsPlayerCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "PlayerVsPlayerCoin Core 0.12.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "playervsplayercoincore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://playervsplayercoin.org/"

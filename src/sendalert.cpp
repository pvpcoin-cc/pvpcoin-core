...
2. run playervsplayercoind with -printalert or -sendalert like this:
   /path/to/playervsplayercoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.playervsplayercoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/PlayerVsPlayerCoin Core:0.12.0.58/"));

...
This document provides guidelines for internationalization of the PlayerVsPlayerCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `playervsplayercoin_en.ts` remains unchanged.

...
This mechanism has been integrated into Bitcore-Node-PlayerVsPlayerCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/playervsplayercoinpay/insight-api-playervsplayercoin#web-socket-api](https://github.com/playervsplayercoinpay/insight-api-playervsplayercoin#web-socket-api)
* API: [https://github.com/playervsplayercoinpay/insight-api-playervsplayercoin#instantsend-transactions](https://github.com/playervsplayercoinpay/insight-api-playervsplayercoin#instantsend-transactions)
...
By default, the PlayerVsPlayerCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PlayerVsPlayerCoin Core daemon:
